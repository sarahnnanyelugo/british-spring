...
import "./junior.scss";
import JuniorGirl from "../../../assets/images/craft.jpg";
      ...
      <div className="junior-div">
        ...
        <div className="col-md-8 offset-md-2 d-md-flex main-body">
          <div className="col-md-6">
            <h4>British Spring Senior Secondary</h4>

            <h3>British Spring: The Perfect Start to a Brighter Future!</h3>
          </div>
          <div className="col-md-6 ">
        ...
        <div className="col-md-12 profile">
          <center>
            <h1>British Spring College; Senior Category</h1>
        ...
        <div className="col-md-8 offset-md-2 d-md-flex general">
          ...
          <div className="col-md-9">
            <h2> SETTING THE FOUNDATION IN JUNIOR SCHOOL: SSS 1-3</h2>
            <p>
